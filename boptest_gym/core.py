...
from boptest_gym.test_and_plot import plot_results, test_agent
...
class DiscretizedObservationWrapper(gym.ObservationWrapper):
    ...
    def __init__(self, env, n_bins_obs=10):
        ...
        low     = self.observation_space.low # pylint: disable=no-member
        high    = self.observation_space.high # pylint: disable=no-member
...
class DiscretizedActionWrapper(gym.ActionWrapper):
    ...
    def __init__(self, env, n_bins_act=10):
        ...
        # Get observation space bounds
        low     = self.action_space.low # pylint: disable=no-member
        high    = self.action_space.high # pylint: disable=no-member
